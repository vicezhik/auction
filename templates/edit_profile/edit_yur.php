...
<div class="profile bg-gray">
    <div class="wrapper">
        <ul class="breadcrumbs">
            ...
            <li><span>ООО “РРТ Автомаркет”</span></li>
        </ul>
        ...
        <div class="pf__edit-box ">
            <div class="pf__edit-top">
                ...
                <div class="pf__edit-user">
                    <div class="name">ООО “РРТ Автомаркет”</div>
                    <div class="type">Юридическое лицо / Продавец</div>
            ...
            <div class="pf__edit-data accordeon-out ">
                <div class="pf__data-title accordeon-title accordeon-open" data-accordeon=".pf__ooo-data">
                    <span class="icon-ooo"></span>
                    <span class=" title-text">Данные организации</span>
                    <i class="icon-down"></i>
                </div>
                <div class="accordeon-box pf__ooo-data" style="display:block">
                    <div class="pf__form">
